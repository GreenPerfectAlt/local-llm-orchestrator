...
"%LLAMA_CLI%" -m "%SELECTED_MODEL%" !MMPROJ_ARG! !SYS_ARG! !FILE_ARG! ^
--ctx-size 128000 --reasoning off --reasoning-budget 0 --mmap ^
--samplers penalties;top_k;top_p;min_p;temperature;adaptive ^
--temp 1.0 --min-p 0.1 --top-p 0.95 --top-k 40 ^
--adaptive-target 0.85 --adaptive-decay 0.90 ^
