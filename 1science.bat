...
start "KOBOLD" /high "%KOBOLDCPP%" ^
 ...
 --highpriority --autofit ^
 --usevulkan 0 --flashattention ^
 --quantkv 0 ^
 --usemmap ^
 --foreground ^
 --skiplauncher
...
start "LLAMA_SERVER" /high "%LLAMA_SERVER%" ^
 ...
 --port 11434 ^
 --mmap ^
 -ngl -1 -n -1 -t 6 -tb 6 --prio 3 ^
 -b 1024 -ub 512 --reasoning off --reasoning-budget 0 ^
 --flash-attn on --cache-type-k q8_0 --cache-type-v iq4_nl --cache-ram 2048 ^
 --fit on --parallel 1 --keep -1 --poll 100 ^
 -dio --no-host ^
...
start "LLAMA_SERVER" /high "%LLAMA_SERVER%" ^
 ...
 -c %C_SIZE% ^
 -t 6 -tb 6 ^
 --context-shift --cache-ram 0 --no-host ^  
 --flash-attn on --jinja ^
 -b 521 -ub 521 ^
 --n-gpu-layers -1 --cpu-strict 1 --prio 2
...
"%LLAMA_CLI%" ^
 ...
 --mmap ^
 --conversation --no-display-prompt --color on --jinja ^
 -n -1 -t 4 -tb 4 --prio 3 --cache-ram 2048 ^
 -dio --no-host --flash-attn on --fit on --parallel 1 ^
 !SYS_ARG! ^
 !FILE_ARG!
...
:: температура --temp 1.0 --dynatemp-exp 1.0 --dynatemp-range 0.4 --min-p 0.1 --repeat_penalty 1.1 ^
::  --xtc-threshold 0.1 --xtc-probability 0.2
:: -ctk q8_0 -ctv q8_0
