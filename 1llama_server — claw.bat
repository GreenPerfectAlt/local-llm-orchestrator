...
"%LLAMA_SERVER%" -m "%SELECTED_MODEL%" !MMPROJ_ARG! --port 11434 -c 32000 -ngl -1 -n -1 --prio 3 --reasoning off --reasoning-budget 0 -ctk q4_0 -ctv q4_0 --keep 1 --fit on -fa on --parallel 1 --mmap --cache-ram 1024 -b 2048 -ub 512 --embedding --api-key sk-no-key-needed --chat-template chatml
...
::  --numa distribute -dio -nkvo
::  --xtc-threshold 0.1 --xtc-probability 0.5 --dry-multiplier 0.8 --dry-base 1.75 --dry-allowed-length 4 --mirostat 0 --min-p 0.1 --temp 1.0 --dynatemp-exp 1.0 --dynatemp-range 0.2
