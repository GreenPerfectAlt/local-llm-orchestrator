...
set LLAMA_FLAGS=--ctx-size 128000 -ctk q4_0 -ctv q4_0 --reasoning off --reasoning-budget 0 --mmap ^
-n -1 -ngl -1 -t 6 -tb 6 --prio 3 -fa on -fit on --numa distribute --cache-ram 512 ^
--override-kv gemma4.expert_used_count=int:16 -ctxcp 2 ^
--parallel 1 --jinja --keep 1 --embedding --api-key sk-no-key-needed --port 11434 
